...
Optimal_Multi_algo_HP_dict = {
    ...
    'patchtrad': {'win_size': 50, 'lr': 0.0001, 'patch_len': 16, 'stride': 12, 'd_model': 128, 'n_heads': 4, 'n_layers': 3, 'd_ff': 512},
    #####
    'patchtradmv': {'win_size': 50, 'lr': 0.0001, 'patch_len': 16, 'stride': 12, 'd_model': 128, 'n_heads': 4, 'n_layers': 3, 'd_ff': 512},
...
Optimal_Uni_algo_HP_dict = {
    ...
    ###
    'patchtradmv': {'win_size': 50, 'lr': 0.0001, 'patch_len': 16, 'stride': 12, 'd_model': 128, 'n_heads': 4, 'n_layers': 3, 'd_ff': 512},
    'CRIB': {'d_model': 32, 'seq_len': 25, 'patch_len': 8},
    'IMAD': {'mid_dim': 128},
